...
import com.facemarker.env.BorderedText;
import com.facemarker.env.FileUtils;
import com.facemarker.env.ImageUtils;
import com.facemarker.env.Logger;
import com.facemarker.tracking.MultiBoxTracker;
...
public class MainActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    public static List<String> detected_names = new ArrayList<String>();
    @Override
                                ...
                                new AlertDialog.Builder(this)
                                        ...
                                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                Toast.makeText(getBaseContext(), "Deleted all names!", Toast.LENGTH_LONG).show();
                                            }
                                        })
    ...
    protected void processImage() {
        ...
        runInBackground(
                () -> {
                    ...
                    // Add all detected faces to arraylist
                    for(Classifier.Recognition x : mappedRecognitions)
                    {
                        // Add unique names to the arraylist
                        if(!x.getTitle().equals("Unknown"))
                        {
                            if(!(detected_names.contains(x.getTitle())))
                                detected_names.add(x.getTitle());
                        }
                    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            new Thread(() -> {
                try {
                    classifier.updateData(requestCode, getContentResolver(), uris, this);
                } catch (Exception e) {
