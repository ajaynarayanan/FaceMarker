...
package com.facemarker.tracking;
...
import com.facemarker.scan.Classifier.Recognition;
        ...
        for (final TrackedRecognition recognition : trackedObjects) {
            ...
            final String labelString =
                    !TextUtils.isEmpty(recognition.title)
                            ? String.format("%s", recognition.title)//String.format("%s %.2f", recognition.title, recognition.detectionConfidence)
